...
<template>
  <header>
    <nav>
      <div class="title">
        <img src="./assets/images/logo_locallink.png" />
      ...
      <ul>
        ...
        <li>
          <RouterLink :to="{ name: 'Channel' }" :class="{ underline: currentRouteName == 'Channel' }"> Channel </RouterLink>
        </li>
        <li>
...
nav {
  padding: 1em 2em;
  background-color: rgb(162, 202, 16);
  display: flex;
  align-items: center;
}
